...
Write-Host "  MINDLOCK - Visible Dart SDK Fix" -ForegroundColor Cyan
Write-Host "======================================" -ForegroundColor Cyan

$engineVersion = Get-Content "C:\flutter\flutter\bin\internal\engine.version"
$dartZipUrl = "https://storage.flutter-io.cn/flutter_infra_release/flutter/$engineVersion/dart-sdk-windows-x64.zip"
$zipPath = "C:\flutter\dart-sdk.zip"
$cachePath = "C:\flutter\flutter\bin\cache"
$dartSdkPath = "$cachePath\dart-sdk"

Write-Host "Downloading Dart SDK (Size: ~250 MB)..." -ForegroundColor Yellow
...
# Use BITS transfer to show a clear progress bar!
Import-Module BitsTransfer
Start-BitsTransfer -Source $dartZipUrl -Destination $zipPath
